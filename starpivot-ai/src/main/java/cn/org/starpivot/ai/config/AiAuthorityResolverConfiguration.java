...
import cn.org.starpivot.ai.security.AiPermissionLoader;
...
public class AiAuthorityResolverConfiguration {

    private final AiPermissionLoader permissionLoader;
    private final PermissionCacheService permissionCacheService;
    private final PermissionLoadFailureRecorder permissionLoadFailureRecorder;

    @Value("${spring.application.name:starpivot-ai}")
    private String applicationName;

    @Bean
    public AuthorityResolver authorityResolver() {
        return new AiAuthorityResolver(
                permissionLoader, permissionCacheService, permissionLoadFailureRecorder, applicationName);
    }

    @Slf4j
    static final class AiAuthorityResolver implements AuthorityResolver {
        ...
        AiAuthorityResolver(
                AiPermissionLoader permissionLoader,
