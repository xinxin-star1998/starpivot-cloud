...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '文件中心-文件元数据' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_file` VALUES (9, 11, 'SYSTEM', 'IMAGE', 'avatar7.webp', 'webp', 'image/webp', 2712, 'file/system/11/2026/06/23/6dd6d4d7-efd7-40c7-929e-0a200020f744.webp', NULL, 'OSS', NULL, NULL, '0', NULL, NULL, 'admin', '2026-06-23 10:21:33', '', NULL, NULL);
...
CREATE TABLE `sys_file_folder`  (
  ...
  `parent_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '父文件夹ID（双层结构固定为0）',
  `order_num` int(11) NULL DEFAULT 0 COMMENT '显示顺序',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 480 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 305 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (24, '商品管理', 4, 1, 'pms', '', NULL, 'GoodManager', 1, 1, 'M', '0', '0', '', 'ep:goods-filled', 'admin', '2026-05-15 10:38:29', 'admin', '2026-06-23 19:58:02', '');
INSERT INTO `sys_menu` VALUES (25, '分类维护', 24, 1, 'category', '/mall/pms/category/index', NULL, 'CategoryManager', 1, 1, 'C', '0', '0', 'mall:category:list', 'ri:node-tree', 'admin', '2026-05-15 10:43:03', 'admin', '2026-06-23 21:13:33', '');
INSERT INTO `sys_menu` VALUES (26, '品牌列表', 24, 2, 'brand', '/mall/pms/brand/index', NULL, 'BrandManager', 1, 1, 'C', '0', '0', 'mall:brand:list', 'ep:shop', 'admin', '2026-04-23 20:25:38', 'admin', '2026-06-23 21:13:40', '品牌管理');
...
INSERT INTO `sys_menu` VALUES (28, '商品维护', 24, 4, 'maintain', '', NULL, 'GoodsMaintain', 1, 1, 'M', '0', '0', 'mall:product:list', 'ep:goods-filled', 'admin', '2026-04-23 20:27:38', 'admin', '2026-06-24 13:11:09', '商品管理');
INSERT INTO `sys_menu` VALUES (29, '属性分组', 27, 1, 'group', '/mall/pms/group/index', NULL, 'AttrgroupManager', 1, 1, 'C', '0', '0', '', 'ep:histogram', 'admin', '2026-05-18 14:59:27', 'admin', '2026-06-23 21:13:54', '');
INSERT INTO `sys_menu` VALUES (30, '规格参数', 27, 2, 'base', '/mall/pms/attr/base/index', NULL, 'BaseParam', 1, 1, 'C', '0', '0', '', 'ep:document', 'admin', '2026-05-18 15:06:50', 'admin', '2026-06-23 21:14:05', '');
INSERT INTO `sys_menu` VALUES (31, '销售属性', 27, 3, 'sale', '/mall/pms/attr/sale/index', NULL, 'SalesAttributes', 1, 1, 'C', '0', '0', '', 'ep:present', 'admin', '2026-05-18 15:12:11', 'admin', '2026-06-23 21:14:16', '');
...
INSERT INTO `sys_menu` VALUES (131, '仓库系统', 4, 1, 'wms', '', NULL, 'WmsManager', 1, 1, 'M', '0', '0', '', 'mdi:warehouse', 'admin', '2026-05-19 15:26:07', 'admin', '2026-06-23 16:45:46', '仓储服务');
INSERT INTO `sys_menu` VALUES (132, '仓库维护', 131, 1, 'warehouse', '/mall/wms/warehouse/index', NULL, 'WareHouse', 1, 1, 'C', '0', '0', '', 'ep:office-building', 'admin', '2026-05-19 15:29:10', 'admin', '2026-06-23 16:45:58', '仓库管理');
...
INSERT INTO `sys_menu` VALUES (169, '文件中心', 0, 4, '/file', '', NULL, 'FileCenter', 1, 1, 'M', '0', '0', '', 'ep:folder-opened', 'admin', '2026-06-22 19:45:35', '', NULL, '文件中心模块');
INSERT INTO `sys_menu` VALUES (170, '文件管理', 169, 1, 'index', '/file/index', NULL, 'FileManage', 1, 1, 'C', '0', '0', 'file:resource:list', 'ep:document', 'admin', '2026-06-22 19:45:35', '', NULL, '文件管理页面');
INSERT INTO `sys_menu` VALUES (171, '文件查询', 170, 1, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:query', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '文件列表/详情/预览');
INSERT INTO `sys_menu` VALUES (172, '文件上传', 170, 2, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:add', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '上传文件');
INSERT INTO `sys_menu` VALUES (173, '文件删除', 170, 3, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:delete', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '逻辑删除');
INSERT INTO `sys_menu` VALUES (174, '文件恢复', 170, 4, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:restore', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '回收站恢复');
INSERT INTO `sys_menu` VALUES (175, '文件夹查询', 170, 5, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:folder:query', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '文件夹树');
INSERT INTO `sys_menu` VALUES (176, '文件夹新增', 170, 6, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:folder:add', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '新建文件夹');
INSERT INTO `sys_menu` VALUES (177, '文件夹编辑', 170, 7, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:folder:edit', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '重命名/排序');
INSERT INTO `sys_menu` VALUES (178, '文件夹删除', 170, 8, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:folder:delete', '#', 'admin', '2026-06-22 19:45:35', '', NULL, '删除文件夹');
INSERT INTO `sys_menu` VALUES (179, '文件迁移', 170, 9, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:move', '#', 'admin', '2026-06-22 20:54:50', '', NULL, '迁移到其他文件夹');
INSERT INTO `sys_menu` VALUES (180, 'spu管理', 28, 1, 'spu', '/mall/pms/product/spu/index', NULL, 'SpuManager', 1, 1, 'C', '0', '0', '', 'ri:shining-2-line', 'admin', '2026-06-23 16:40:46', 'admin', '2026-06-23 21:23:25', '');
INSERT INTO `sys_menu` VALUES (181, '发布商品', 28, 2, 'publish', '/mall/pms/product/publish/index', NULL, 'PublishSPU', 1, 1, 'C', '0', '0', '', 'heroicons-outline:annotation', 'admin', '2026-06-23 16:43:05', 'admin', '2026-06-23 21:24:37', '');
INSERT INTO `sys_menu` VALUES (182, '商品管理', 28, 3, 'manager', '/mall/pms/product/manager/index', NULL, 'GoodsManager', 1, 1, 'C', '0', '0', '', 'ep:apple', 'admin', '2026-06-23 16:44:11', 'admin', '2026-06-23 21:25:22', '');
INSERT INTO `sys_menu` VALUES (183, '库存工作单', 131, 4, 'task', '/mall/wms/task/index', NULL, 'TaskManager', 1, 1, 'C', '0', '0', 'mall:task:list', 'ri:task-fill', 'admin', '2026-06-23 16:47:13', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (184, '采购单维护', 131, 5, 'PurchaseOrder', '', NULL, '', 1, 1, 'M', '0', '0', '', '#', 'admin', '2026-06-23 16:48:04', 'admin', '2026-06-23 16:50:35', '');
INSERT INTO `sys_menu` VALUES (185, '采购需求', 184, 1, 'purchaseitem', '/mall/wms/purchaseitem/index', NULL, '', 1, 1, 'C', '0', '0', 'mall:purchase:item', '#', 'admin', '2026-06-23 16:49:05', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (186, '采购单', 184, 2, 'purchaseorder', '/mall/wms/purchaseorder/index', NULL, '', 1, 1, 'C', '0', '0', 'mall:purchase:list', '#', 'admin', '2026-06-23 16:52:05', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (187, '优惠营销', 4, 1, 'sms', '', NULL, 'PromotionMarketing', 1, 1, 'M', '0', '0', '', 'ep:promotion', 'admin', '2026-06-23 16:55:30', 'admin', '2026-06-23 19:58:27', '');
INSERT INTO `sys_menu` VALUES (188, '优惠券管理', 187, 1, 'coupon', '/mall/sms/coupon/coupon/index', NULL, 'CouponManager', 1, 1, 'C', '0', '0', 'mall:coupon:list', 'mdi:candy', 'admin', '2026-06-23 16:56:59', 'admin', '2026-06-24 13:12:06', '');
INSERT INTO `sys_menu` VALUES (189, '发放记录', 187, 2, 'history', '/mall/sms/coupon/history/index', NULL, 'HistoryManager', 1, 1, 'C', '0', '0', 'mall:coupon:history', 'ri:coupon-2-line', 'admin', '2026-06-23 16:57:58', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (190, '专题活动', 187, 3, 'subject', '/mall/sms/coupon/subject/index', NULL, 'SubjectManager', 1, 1, 'C', '0', '0', 'mall:subject:list', 'ep:aim', 'admin', '2026-06-23 16:59:42', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (191, '秒杀活动', 187, 4, 'seckill', '/mall/sms/coupon/seckill/index', NULL, 'SeckillManager', 1, 1, 'C', '0', '0', 'mall:seckill:list', '#', 'admin', '2026-06-23 17:00:55', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (192, '积分维护', 187, 5, 'bounds', '/mall/sms/coupon/bounds/index', NULL, 'BoundsManager', 1, 1, 'C', '0', '0', 'mall:bounds:list', '#', 'admin', '2026-06-23 17:02:00', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (193, '满减折扣', 187, 6, 'full', '/mall/sms/coupon/full/index', NULL, 'FullManager', 1, 1, 'C', '0', '0', 'mall:reduction:list', '#', 'admin', '2026-06-23 17:02:43', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (194, '会员价格', 187, 7, 'memberprice', '/mall/sms/coupon/memberprice/index', NULL, 'Memberprice', 1, 1, 'C', '0', '0', 'mall:memberprice:list', '#', 'admin', '2026-06-23 17:03:36', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (195, '每日秒杀', 187, 8, 'seckillsession', '/mall/sms/coupon/seckillsession/index', NULL, 'Seckillsession', 1, 1, 'C', '0', '0', 'mall:seckill:session', '#', 'admin', '2026-06-23 17:05:50', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (196, '订单系统', 4, 4, 'oms', '', NULL, 'OrderManager', 1, 1, 'M', '0', '0', '', 'mdi:order-bool-descending-variant', 'admin', '2026-06-23 17:07:36', 'admin', '2026-06-23 19:59:00', '');
INSERT INTO `sys_menu` VALUES (197, '订单查询', 196, 1, 'order', '/mall/oms/order/order/index', NULL, 'OrderQuery', 1, 1, 'C', '0', '0', 'mall:order:list', '#', 'admin', '2026-06-23 17:08:34', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (198, '退货单处理', 196, 2, 'return', '/mall/oms/order/return/index', NULL, 'OrderReturn', 1, 1, 'C', '0', '0', 'mall:return:list', '#', 'admin', '2026-06-23 17:09:12', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (199, '等级规则', 196, 3, 'level', '/mall/oms/order/level/index', NULL, 'LevelSettings', 1, 1, 'C', '0', '0', 'mall:order:setting', '#', 'admin', '2026-06-23 17:10:11', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (200, '支付流水查询', 196, 4, 'payment', '/mall/oms/order/payment/index', NULL, 'PaymentLog', 1, 1, 'C', '0', '0', 'mall:payment:list', '#', 'admin', '2026-06-23 17:11:01', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (201, '退款流水查询', 196, 5, 'refund', '/mall/oms/order/refund/index', NULL, 'RefundLog', 1, 1, 'C', '0', '0', 'mall:refund:list', '#', 'admin', '2026-06-23 17:11:42', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (202, '用户系统', 4, 5, 'ums', '', NULL, 'MemberSystem', 1, 1, 'M', '0', '0', '', 'mdi:wallet-membership', 'admin', '2026-06-23 17:12:59', 'admin', '2026-06-23 19:59:22', '');
INSERT INTO `sys_menu` VALUES (203, '会员列表', 202, 1, 'member', '/mall/ums/member/member/index', NULL, 'MemberList', 1, 1, 'C', '0', '0', 'mall:member:list', '#', 'admin', '2026-06-23 17:13:52', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (204, '会员等级', 202, 2, 'level', '/mall/ums/member/level/index', NULL, 'MemberLevel', 1, 1, 'C', '0', '0', 'mall:member:level', '#', 'admin', '2026-06-23 17:14:34', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (205, '积分变化', 202, 3, 'growth', '/mall/ums/member/growth/index', NULL, 'GrowthRecord', 1, 1, 'C', '0', '0', 'mall:member:growth', '#', 'admin', '2026-06-23 17:15:27', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (206, '统计信息', 202, 4, 'statistics', '/mall/ums/member/statistics/index', NULL, 'MemberStatistics', 1, 1, 'C', '0', '0', 'mall:member:statistics', '#', 'admin', '2026-06-23 17:16:07', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (207, '内容管理', 4, 6, 'cms', '', NULL, 'ContentManage', 1, 1, 'M', '0', '0', '', 'mdi:content-paste', 'admin', '2026-06-23 17:17:02', 'admin', '2026-06-23 19:59:30', '');
INSERT INTO `sys_menu` VALUES (208, '首页推荐', 207, 1, 'home', '/mall/cms/content/home/index', NULL, 'HomeRecommend', 1, 1, 'C', '0', '0', 'mall:adv:list', '#', 'admin', '2026-06-23 17:18:06', 'admin', '2026-06-24 13:11:09', ' — （路由：content/index）');
INSERT INTO `sys_menu` VALUES (209, '分类热门', 207, 2, 'category', '/mall/cms/content/category/index', NULL, 'CategoryHot', 1, 1, 'C', '0', '0', '', '#', 'admin', '2026-06-23 17:18:49', 'admin', '2026-06-24 13:11:09', '无独立表，引导至专题活动 sms_home_subject');
INSERT INTO `sys_menu` VALUES (210, '评论管理', 207, 3, 'comments', '/mall/cms/content/comments/index', NULL, 'CommentManage', 1, 1, 'C', '0', '0', 'mall:comment:list', '#', 'admin', '2026-06-23 17:19:35', 'admin', '2026-06-24 13:11:09', '');
INSERT INTO `sys_menu` VALUES (280, 'C端商城', 4, 0, '/portal', '', NULL, 'MallPortal', 1, 1, 'C', '0', '0', '', 'ep:shopping-bag', 'admin', '2026-06-24 13:11:09', '', NULL, '打开 C 端商城前台');
INSERT INTO `sys_menu` VALUES (281, 'SKU 管理', 28, 4, 'sku', '/mall/pms/sku/index', NULL, 'PmsSkuManager', 1, 1, 'C', '0', '0', 'mall:product:list', 'mdi:barcode', 'admin', '2026-06-24 13:11:09', '', NULL, 'PMS SKU 独立管理');
INSERT INTO `sys_menu` VALUES (282, '订单查询', 197, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:order:query', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (283, '订单发货', 197, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:order:deliver', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (284, '关闭订单', 197, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:order:close', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (285, '退货审核', 198, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:return:audit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (286, '退货查询', 198, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:return:query', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (287, '优惠券新增', 188, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:coupon:add', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (288, '优惠券修改', 188, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:coupon:edit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (289, '优惠券删除', 188, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:coupon:delete', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (290, '会员查询', 203, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:member:query', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (291, '会员修改', 203, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:member:edit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (292, '采购单查询', 186, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:purchase:query', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (293, '工作单处理', 183, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:task:edit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (294, '商品查询', 180, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:product:query', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (295, '商品新增', 180, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:product:add', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (296, '商品修改', 180, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:product:edit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (297, '商品删除', 180, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:product:delete', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (298, '轮播新增', 208, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:adv:add', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (299, '轮播修改', 208, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:adv:edit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (300, '轮播删除', 208, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:adv:delete', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (301, '评论查询', 210, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:comment:query', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (302, '评论修改', 210, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:comment:edit', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (303, '评论删除', 210, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:comment:delete', '#', 'admin', '2026-06-24 13:11:09', '', NULL, '');
INSERT INTO `sys_menu` VALUES (304, '工作单列表', 183, 2, '', '', NULL, '', 1, 1, 'F', '0', '0', 'mall:task:list', '#', 'admin', '2026-06-24 13:16:20', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4836 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_oper_log` VALUES (4732, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":1},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-22 17:58:58', 292);
INSERT INTO `sys_oper_log` VALUES (4733, '修改当前用户密码', 2, 'cn.org.starpivot.system.controller.SysUserController.updatePwd()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/user/updatePwd', '0:0:0:0:0:0:0:1', '内网IP', '{\"oldPassword\":\"******\",\"newPassword\":\"******\"}', '{\"code\":200,\"fail\":false,\"message\":\"修改密码成功，请重新登录\",\"success\":true}', 0, '', '2026-06-23 10:11:22', 400);
INSERT INTO `sys_oper_log` VALUES (4734, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":469,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:10:51\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":468,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:46:01\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":467,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:45:48\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":5},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 10:15:34', 136);
INSERT INTO `sys_oper_log` VALUES (4735, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":469,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:10:51\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":468,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:46:01\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":467,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:45:48\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":5},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 10:16:04', 17);
INSERT INTO `sys_oper_log` VALUES (4736, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":469,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:10:51\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":468,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:46:01\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":467,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:45:48\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":5},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 10:16:05', 14);
INSERT INTO `sys_oper_log` VALUES (4737, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":469,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:10:51\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":468,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:46:01\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":467,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:45:48\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":5},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 10:16:06', 16);
INSERT INTO `sys_oper_log` VALUES (4738, '操作日志', 0, 'cn.org.starpivot.system.controller.SysOperLogController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/operlog/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":2,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"businessType\":0,\"costTime\":16,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":{\\\"pageCount\\\":1,\\\"pageNum\\\":1,\\\"pageSize\\\":20,\\\"rows\\\":[{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":470,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-23 10:11:29\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":469,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-23 10:10:51\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":468,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-22 19:46:01\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":467,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-22 19:45:48\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":466,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-22 17:29:56\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"}],\\\"total\\\":5},\\\"fail\\\":false,\\\"message\\\":\\\"操作成功\\\",\\\"success\\\":true}\",\"method\":\"cn.org.starpivot.system.controller.SysLogininforController.pageList()\",\"operId\":4737,\"operIp\":\"0:0:0:0:0:0:0:1\",\"operLocation\":\"内网IP\",\"operName\":\"admin\",\"operParam\":\"{\\\"pageNum\\\":1,\\\"pageSize\\\":20}\",\"operTime\":\"2026-06-23 10:16:06\",\"operUrl\":\"/api/v1/sys/logininfor/pageList\",\"operatorType\":1,\"requestMethod\":\"POST\",\"status\":0,\"title\":\"登录日志\"},{\"businessType\":0,\"costTime\":14,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":{\\\"pageCount\\\":1,\\\"pageNum\\\":1,\\\"pageSize\\\":20,\\\"rows\\\":[{\\\"browser\\\":...', 0, '', '2026-06-23 10:31:41', 32);
INSERT INTO `sys_oper_log` VALUES (4739, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":469,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:10:51\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":468,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:46:01\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":467,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:45:48\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":5},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 10:31:42', 10);
INSERT INTO `sys_oper_log` VALUES (4740, '操作日志', 0, 'cn.org.starpivot.system.controller.SysOperLogController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/operlog/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":2,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"businessType\":0,\"costTime\":10,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":{\\\"pageCount\\\":1,\\\"pageNum\\\":1,\\\"pageSize\\\":20,\\\"rows\\\":[{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":470,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-23 10:11:29\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":469,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-23 10:10:51\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":468,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-22 19:46:01\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":467,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-22 19:45:48\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"},{\\\"browser\\\":\\\"Chrome\\\",\\\"infoId\\\":466,\\\"ipaddr\\\":\\\"0:0:0:0:0:0:0:1\\\",\\\"loginLocation\\\":\\\"内网IP\\\",\\\"loginTime\\\":\\\"2026-06-22 17:29:56\\\",\\\"msg\\\":\\\"登录成功\\\",\\\"os\\\":\\\"Windows 10\\\",\\\"status\\\":\\\"0\\\",\\\"userName\\\":\\\"admin\\\"}],\\\"total\\\":5},\\\"fail\\\":false,\\\"message\\\":\\\"操作成功\\\",\\\"success\\\":true}\",\"method\":\"cn.org.starpivot.system.controller.SysLogininforController.pageList()\",\"operId\":4739,\"operIp\":\"0:0:0:0:0:0:0:1\",\"operLocation\":\"内网IP\",\"operName\":\"admin\",\"operParam\":\"{\\\"pageNum\\\":1,\\\"pageSize\\\":20}\",\"operTime\":\"2026-06-23 10:31:42\",\"operUrl\":\"/api/v1/sys/logininfor/pageList\",\"operatorType\":1,\"requestMethod\":\"POST\",\"status\":0,\"title\":\"登录日志\"},{\"businessType\":0,\"costTime\":32,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":{\\\"pageCount\\\":2,\\\"pageNum\\\":1,\\\"pageSize\\\":20,\\\"rows\\\":[{\\\"businessTy...', 0, '', '2026-06-23 15:54:19', 182);
INSERT INTO `sys_oper_log` VALUES (4741, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":472,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 15:53:55\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":471,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 14:48:34\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":469,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:10:51\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":468,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:46:01\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":467,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 19:45:48\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":466,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-22 17:29:56\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"}],\"total\":7},\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 15:54:20', 15);
INSERT INTO `sys_oper_log` VALUES (4742, '删除菜单', 3, 'cn.org.starpivot.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', '星枢科技', '/api/v1/sys/menu/delete', '0:0:0:0:0:0:0:1', '内网IP', '{\"ids\":[130]}', '{\"code\":200,\"data\":\"删除菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:34:32', 50);
INSERT INTO `sys_oper_log` VALUES (4743, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":28,\"menuName\":\"商品维护\",\"parentId\":24,\"orderNum\":4,\"path\":\"product\",\"component\":\"\",\"routeName\":\"ProductManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"mall:product:list\",\"icon\":\"ep:goods-filled\",\"remark\":\"商品管理\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:36:18', 27);
INSERT INTO `sys_oper_log` VALUES (4744, '删除菜单', 3, 'cn.org.starpivot.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', '星枢科技', '/api/v1/sys/menu/delete', '0:0:0:0:0:0:0:1', '内网IP', '{\"ids\":[126]}', '{\"code\":200,\"data\":\"删除菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:36:34', 19);
INSERT INTO `sys_oper_log` VALUES (4745, '删除菜单', 3, 'cn.org.starpivot.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', '星枢科技', '/api/v1/sys/menu/delete', '0:0:0:0:0:0:0:1', '内网IP', '{\"ids\":[127]}', '{\"code\":200,\"data\":\"删除菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:36:37', 14);
INSERT INTO `sys_oper_log` VALUES (4746, '删除菜单', 3, 'cn.org.starpivot.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', '星枢科技', '/api/v1/sys/menu/delete', '0:0:0:0:0:0:0:1', '内网IP', '{\"ids\":[128]}', '{\"code\":200,\"data\":\"删除菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:36:40', 19);
INSERT INTO `sys_oper_log` VALUES (4747, '删除菜单', 3, 'cn.org.starpivot.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', '星枢科技', '/api/v1/sys/menu/delete', '0:0:0:0:0:0:0:1', '内网IP', '{\"ids\":[129]}', '{\"code\":200,\"data\":\"删除菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:36:42', 19);
INSERT INTO `sys_oper_log` VALUES (4748, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"spu管理\",\"parentId\":28,\"orderNum\":1,\"path\":\"product\",\"component\":\"/product/spu/index\",\"routeName\":\"SpuManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:shining-2-line\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:40:46', 20);
INSERT INTO `sys_oper_log` VALUES (4749, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":28,\"menuName\":\"商品维护\",\"parentId\":24,\"orderNum\":4,\"path\":\"product\",\"component\":\"\",\"routeName\":\"ProductManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:goods-filled\",\"remark\":\"商品管理\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:41:17', 20);
INSERT INTO `sys_oper_log` VALUES (4750, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"发布商品\",\"parentId\":28,\"orderNum\":2,\"path\":\"product\",\"component\":\"/product/add/index\",\"routeName\":\"SpuAdd\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"heroicons-outline:annotation\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:43:05', 11);
INSERT INTO `sys_oper_log` VALUES (4751, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"商品管理\",\"parentId\":28,\"orderNum\":1,\"path\":\"product\",\"component\":\"/product/manager/index\",\"routeName\":\"SpManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:apple\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:44:11', 23);
INSERT INTO `sys_oper_log` VALUES (4752, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":182,\"menuName\":\"商品管理\",\"parentId\":28,\"orderNum\":3,\"path\":\"product\",\"component\":\"/product/manager/index\",\"routeName\":\"SpManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:apple\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:44:17', 14);
INSERT INTO `sys_oper_log` VALUES (4753, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":131,\"menuName\":\"仓库系统\",\"parentId\":4,\"orderNum\":1,\"path\":\"wms\",\"component\":\"\",\"routeName\":\"WmsManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:warehouse\",\"remark\":\"仓储服务\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:45:46', 14);
INSERT INTO `sys_oper_log` VALUES (4754, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":132,\"menuName\":\"仓库维护\",\"parentId\":131,\"orderNum\":1,\"path\":\"warehouse\",\"component\":\"/mall/wms/warehouse/index\",\"routeName\":\"WareHouse\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:office-building\",\"remark\":\"仓库管理\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:45:58', 14);
INSERT INTO `sys_oper_log` VALUES (4755, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"库存工作单\",\"parentId\":131,\"orderNum\":4,\"path\":\"task\",\"component\":\"/wms/task/index\",\"routeName\":\"TaskManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:task-fill\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:47:13', 20);
INSERT INTO `sys_oper_log` VALUES (4756, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"采购单维护\",\"parentId\":131,\"orderNum\":1,\"component\":\"\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:48:04', 18);
INSERT INTO `sys_oper_log` VALUES (4757, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"采购需求\",\"parentId\":184,\"orderNum\":1,\"path\":\"purchaseitem\",\"component\":\"/wms/purchaseitem/index\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:49:05', 13);
INSERT INTO `sys_oper_log` VALUES (4758, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":184,\"menuName\":\"采购单维护\",\"parentId\":131,\"orderNum\":5,\"component\":\"\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:49:16', 14);
INSERT INTO `sys_oper_log` VALUES (4759, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":184,\"menuName\":\"采购单维护\",\"parentId\":131,\"orderNum\":5,\"path\":\"PurchaseOrder\",\"component\":\"\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:50:35', 13);
INSERT INTO `sys_oper_log` VALUES (4760, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"采购单\",\"parentId\":184,\"orderNum\":2,\"path\":\"purchaseorder\",\"component\":\"/wms/purchaseorder/index\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:52:05', 11);
INSERT INTO `sys_oper_log` VALUES (4761, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"优惠营销\",\"parentId\":4,\"orderNum\":1,\"path\":\"coupon\",\"component\":\"\",\"routeName\":\"PromotionMarketing\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:promotion\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:55:30', 15);
INSERT INTO `sys_oper_log` VALUES (4762, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"优惠券管理\",\"parentId\":187,\"orderNum\":1,\"path\":\"coupon\",\"component\":\"/coupon/coupon/index\",\"routeName\":\"CouponManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:56:59', 18);
INSERT INTO `sys_oper_log` VALUES (4763, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"发放记录\",\"parentId\":187,\"orderNum\":2,\"path\":\"history\",\"component\":\"/coupon/history/index\",\"routeName\":\"HistoryManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:coupon-2-line\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:57:58', 10);
INSERT INTO `sys_oper_log` VALUES (4764, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"专题活动\",\"parentId\":187,\"orderNum\":3,\"path\":\"subject\",\"component\":\"/coupon/subject/index\",\"routeName\":\"SubjectManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:aim\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 16:59:42', 17);
INSERT INTO `sys_oper_log` VALUES (4765, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"秒杀活动\",\"parentId\":187,\"orderNum\":4,\"path\":\"seckill\",\"component\":\"/coupon/seckill/index\",\"routeName\":\"SeckillManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:00:55', 9);
INSERT INTO `sys_oper_log` VALUES (4766, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"积分维护\",\"parentId\":187,\"orderNum\":5,\"path\":\"bounds\",\"component\":\"/coupon/bounds/index\",\"routeName\":\"BoundsManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:02:00', 11);
INSERT INTO `sys_oper_log` VALUES (4767, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"满减折扣\",\"parentId\":187,\"orderNum\":6,\"path\":\"full\",\"component\":\"/coupon/full/index\",\"routeName\":\"FullManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:02:43', 17);
INSERT INTO `sys_oper_log` VALUES (4768, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"会员价格\",\"parentId\":187,\"orderNum\":7,\"path\":\"memberprice\",\"component\":\"/coupon/memberprice/index\",\"routeName\":\"Memberprice\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:03:36', 14);
INSERT INTO `sys_oper_log` VALUES (4769, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"每日秒杀\",\"parentId\":187,\"orderNum\":8,\"path\":\"seckillsession\",\"component\":\"/coupon/seckillsession/index\",\"routeName\":\"Seckillsession\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:05:50', 10);
INSERT INTO `sys_oper_log` VALUES (4770, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"订单系统\",\"parentId\":4,\"orderNum\":4,\"path\":\"order\",\"component\":\"\",\"routeName\":\"OrderManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:07:36', 18);
INSERT INTO `sys_oper_log` VALUES (4771, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"订单查询\",\"parentId\":196,\"orderNum\":1,\"path\":\"order\",\"component\":\"/order/order/index\",\"routeName\":\"OrderQuery\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:08:34', 11);
INSERT INTO `sys_oper_log` VALUES (4772, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"退货单处理\",\"parentId\":196,\"orderNum\":2,\"path\":\"return\",\"component\":\"/order/return/index\",\"routeName\":\"OrderReturn\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:09:12', 18);
INSERT INTO `sys_oper_log` VALUES (4773, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"等级规则\",\"parentId\":196,\"orderNum\":3,\"path\":\"level\",\"component\":\"/order/level/index\",\"routeName\":\"LevelSettings\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:10:11', 10);
INSERT INTO `sys_oper_log` VALUES (4774, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"支付流水查询\",\"parentId\":196,\"orderNum\":4,\"path\":\"payment\",\"component\":\"/order/payment/index\",\"routeName\":\"PaymentLog\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:11:01', 23);
INSERT INTO `sys_oper_log` VALUES (4775, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"退款流水查询\",\"parentId\":196,\"orderNum\":5,\"path\":\"refund\",\"component\":\"/order/refund/index\",\"routeName\":\"RefundLog\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:11:42', 10);
INSERT INTO `sys_oper_log` VALUES (4776, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"用户系统\",\"parentId\":4,\"orderNum\":5,\"path\":\"member\",\"component\":\"\",\"routeName\":\"MemberSystem\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:12:59', 10);
INSERT INTO `sys_oper_log` VALUES (4777, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"会员列表\",\"parentId\":202,\"orderNum\":1,\"path\":\"member\",\"component\":\"/member/member/inidex\",\"routeName\":\"MemberList\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:13:52', 18);
INSERT INTO `sys_oper_log` VALUES (4778, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"会员等级\",\"parentId\":202,\"orderNum\":2,\"path\":\"level\",\"component\":\"/member/level/index\",\"routeName\":\"MemberLevel\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:14:34', 15);
INSERT INTO `sys_oper_log` VALUES (4779, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"积分变化\",\"parentId\":202,\"orderNum\":3,\"path\":\"growth\",\"component\":\"/member/growth/index\",\"routeName\":\"GrowthRecord\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:15:27', 16);
INSERT INTO `sys_oper_log` VALUES (4780, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"统计信息\",\"parentId\":202,\"orderNum\":4,\"path\":\"statistics\",\"component\":\"/member/statistics/index\",\"routeName\":\"MemberStatistics\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:16:07', 15);
INSERT INTO `sys_oper_log` VALUES (4781, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"内容管理\",\"parentId\":4,\"orderNum\":6,\"path\":\"content\",\"component\":\"\",\"routeName\":\"ContentManage\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:17:02', 15);
INSERT INTO `sys_oper_log` VALUES (4782, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"首页推荐\",\"parentId\":207,\"orderNum\":1,\"path\":\"home\",\"component\":\"/content/home/index\",\"routeName\":\"HomeRecommend\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"remark\":\" — （路由：content/index）\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:18:06', 16);
INSERT INTO `sys_oper_log` VALUES (4783, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"分类热门\",\"parentId\":207,\"orderNum\":2,\"path\":\"category\",\"component\":\"/content/category/index\",\"routeName\":\"CategoryHot\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:18:49', 15);
INSERT INTO `sys_oper_log` VALUES (4784, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"评论管理\",\"parentId\":207,\"orderNum\":3,\"path\":\"comments\",\"component\":\"/content/comments/index\",\"routeName\":\"CommentManage\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:19:35', 9);
INSERT INTO `sys_oper_log` VALUES (4785, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":196,\"menuName\":\"订单系统\",\"parentId\":4,\"orderNum\":4,\"path\":\"order\",\"component\":\"\",\"routeName\":\"OrderManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:order-bool-descending-variant\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:20:48', 18);
INSERT INTO `sys_oper_log` VALUES (4786, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":202,\"menuName\":\"用户系统\",\"parentId\":4,\"orderNum\":5,\"path\":\"member\",\"component\":\"\",\"routeName\":\"MemberSystem\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:wallet-membership\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:21:03', 16);
INSERT INTO `sys_oper_log` VALUES (4787, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":207,\"menuName\":\"内容管理\",\"parentId\":4,\"orderNum\":6,\"path\":\"content\",\"component\":\"\",\"routeName\":\"ContentManage\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:content-paste\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 17:21:18', 15);
INSERT INTO `sys_oper_log` VALUES (4788, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":24,\"menuName\":\"商品管理\",\"parentId\":4,\"orderNum\":1,\"path\":\"pms\",\"component\":\"\",\"routeName\":\"GoodManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:goods-filled\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 19:58:02', 55);
INSERT INTO `sys_oper_log` VALUES (4789, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":187,\"menuName\":\"优惠营销\",\"parentId\":4,\"orderNum\":1,\"path\":\"sms\",\"component\":\"\",\"routeName\":\"PromotionMarketing\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:promotion\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 19:58:27', 18);
INSERT INTO `sys_oper_log` VALUES (4790, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":196,\"menuName\":\"订单系统\",\"parentId\":4,\"orderNum\":4,\"path\":\"oms\",\"component\":\"\",\"routeName\":\"OrderManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:order-bool-descending-variant\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 19:59:00', 16);
INSERT INTO `sys_oper_log` VALUES (4791, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":202,\"menuName\":\"用户系统\",\"parentId\":4,\"orderNum\":5,\"path\":\"ums\",\"component\":\"\",\"routeName\":\"MemberSystem\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:wallet-membership\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 19:59:22', 22);
INSERT INTO `sys_oper_log` VALUES (4792, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":207,\"menuName\":\"内容管理\",\"parentId\":4,\"orderNum\":6,\"path\":\"cms\",\"component\":\"\",\"routeName\":\"ContentManage\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:content-paste\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 19:59:30', 17);
INSERT INTO `sys_oper_log` VALUES (4793, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":25,\"menuName\":\"分类维护\",\"parentId\":24,\"orderNum\":1,\"path\":\"category\",\"component\":\"/pms/category/index\",\"routeName\":\"CategoryManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"mall:category:list\",\"icon\":\"ri:node-tree\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 19:59:44', 12);
INSERT INTO `sys_oper_log` VALUES (4794, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":26,\"menuName\":\"品牌列表\",\"parentId\":24,\"orderNum\":2,\"path\":\"brand\",\"component\":\"/pms/brand/index\",\"routeName\":\"BrandManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"mall:brand:list\",\"icon\":\"ep:shop\",\"remark\":\"品牌管理\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:03:33', 200);
INSERT INTO `sys_oper_log` VALUES (4795, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":29,\"menuName\":\"属性分组\",\"parentId\":27,\"orderNum\":1,\"path\":\"group\",\"component\":\"/pms/group/index\",\"routeName\":\"AttrgroupManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:histogram\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:04:09', 18);
INSERT INTO `sys_oper_log` VALUES (4796, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":30,\"menuName\":\"规格参数\",\"parentId\":27,\"orderNum\":2,\"path\":\"base\",\"component\":\"/pms/attr/base/index\",\"routeName\":\"BaseParam\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:document\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:04:21', 22);
INSERT INTO `sys_oper_log` VALUES (4797, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":31,\"menuName\":\"销售属性\",\"parentId\":27,\"orderNum\":3,\"path\":\"sale\",\"component\":\"/pms/attr/sale/index\",\"routeName\":\"SalesAttributes\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:present\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:04:29', 17);
INSERT INTO `sys_oper_log` VALUES (4798, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":25,\"menuName\":\"分类维护\",\"parentId\":24,\"orderNum\":1,\"path\":\"category\",\"component\":\"/mall/pms/category/index\",\"routeName\":\"CategoryManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"mall:category:list\",\"icon\":\"ri:node-tree\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:13:33', 171);
INSERT INTO `sys_oper_log` VALUES (4799, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":26,\"menuName\":\"品牌列表\",\"parentId\":24,\"orderNum\":2,\"path\":\"brand\",\"component\":\"/mall/pms/brand/index\",\"routeName\":\"BrandManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"mall:brand:list\",\"icon\":\"ep:shop\",\"remark\":\"品牌管理\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:13:40', 24);
INSERT INTO `sys_oper_log` VALUES (4800, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":29,\"menuName\":\"属性分组\",\"parentId\":27,\"orderNum\":1,\"path\":\"group\",\"component\":\"/mall/pms/group/index\",\"routeName\":\"AttrgroupManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:histogram\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:13:54', 16);
INSERT INTO `sys_oper_log` VALUES (4801, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":30,\"menuName\":\"规格参数\",\"parentId\":27,\"orderNum\":2,\"path\":\"base\",\"component\":\"/mall/pms/attr/base/index\",\"routeName\":\"BaseParam\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:document\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:14:05', 23);
INSERT INTO `sys_oper_log` VALUES (4802, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":31,\"menuName\":\"销售属性\",\"parentId\":27,\"orderNum\":3,\"path\":\"sale\",\"component\":\"/mall/pms/attr/sale/index\",\"routeName\":\"SalesAttributes\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:present\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:14:16', 25);
INSERT INTO `sys_oper_log` VALUES (4803, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":28,\"menuName\":\"商品维护\",\"parentId\":24,\"orderNum\":4,\"path\":\"maintain\",\"component\":\"\",\"routeName\":\"GoodsMaintain\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:goods-filled\",\"remark\":\"商品管理\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:15:48', 15);
INSERT INTO `sys_oper_log` VALUES (4804, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":180,\"menuName\":\"spu管理\",\"parentId\":28,\"orderNum\":1,\"path\":\"product\",\"component\":\"/mall/pms/product/spu/index\",\"routeName\":\"SpuManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:shining-2-line\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:23:14', 27);
INSERT INTO `sys_oper_log` VALUES (4805, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":180,\"menuName\":\"spu管理\",\"parentId\":28,\"orderNum\":1,\"path\":\"spu\",\"component\":\"/mall/pms/product/spu/index\",\"routeName\":\"SpuManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:shining-2-line\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:23:25', 22);
INSERT INTO `sys_oper_log` VALUES (4806, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":181,\"menuName\":\"发布商品\",\"parentId\":28,\"orderNum\":2,\"path\":\"publish\",\"component\":\"/mall/pms/product/publish/index\",\"routeName\":\"PublishSPU\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"heroicons-outline:annotation\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:24:37', 18);
INSERT INTO `sys_oper_log` VALUES (4807, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":182,\"menuName\":\"商品管理\",\"parentId\":28,\"orderNum\":3,\"path\":\"manager\",\"component\":\"/mall/pms/product/manager/index\",\"routeName\":\"GoodsManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:apple\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:25:22', 20);
INSERT INTO `sys_oper_log` VALUES (4808, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":183,\"menuName\":\"库存工作单\",\"parentId\":131,\"orderNum\":4,\"path\":\"task\",\"component\":\"/mall/wms/task/index\",\"routeName\":\"TaskManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:task-fill\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:32:53', 21);
INSERT INTO `sys_oper_log` VALUES (4809, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":185,\"menuName\":\"采购需求\",\"parentId\":184,\"orderNum\":1,\"path\":\"purchaseitem\",\"component\":\"/mall/wms/purchaseitem/index\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:33:04', 22);
INSERT INTO `sys_oper_log` VALUES (4810, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":186,\"menuName\":\"采购单\",\"parentId\":184,\"orderNum\":2,\"path\":\"purchaseorder\",\"component\":\"/mall/wms/purchaseorder/index\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:33:11', 20);
INSERT INTO `sys_oper_log` VALUES (4811, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":188,\"menuName\":\"优惠券管理\",\"parentId\":187,\"orderNum\":1,\"path\":\"coupon\",\"component\":\"/mall/sms/coupon/coupon/index\",\"routeName\":\"CouponManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:05', 14);
INSERT INTO `sys_oper_log` VALUES (4812, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":189,\"menuName\":\"发放记录\",\"parentId\":187,\"orderNum\":2,\"path\":\"history\",\"component\":\"/mall/sms/coupon/history/index\",\"routeName\":\"HistoryManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ri:coupon-2-line\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:13', 19);
INSERT INTO `sys_oper_log` VALUES (4813, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":190,\"menuName\":\"专题活动\",\"parentId\":187,\"orderNum\":3,\"path\":\"subject\",\"component\":\"/mall/sms/coupon/subject/index\",\"routeName\":\"SubjectManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"ep:aim\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:19', 19);
INSERT INTO `sys_oper_log` VALUES (4814, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":191,\"menuName\":\"秒杀活动\",\"parentId\":187,\"orderNum\":4,\"path\":\"seckill\",\"component\":\"/mall/sms/coupon/seckill/index\",\"routeName\":\"SeckillManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:25', 13);
INSERT INTO `sys_oper_log` VALUES (4815, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":192,\"menuName\":\"积分维护\",\"parentId\":187,\"orderNum\":5,\"path\":\"bounds\",\"component\":\"/mall/sms/coupon/bounds/index\",\"routeName\":\"BoundsManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:32', 18);
INSERT INTO `sys_oper_log` VALUES (4816, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":193,\"menuName\":\"满减折扣\",\"parentId\":187,\"orderNum\":6,\"path\":\"full\",\"component\":\"/mall/sms/coupon/full/index\",\"routeName\":\"FullManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:38', 12);
INSERT INTO `sys_oper_log` VALUES (4817, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":194,\"menuName\":\"会员价格\",\"parentId\":187,\"orderNum\":7,\"path\":\"memberprice\",\"component\":\"/mall/sms/coupon/memberprice/index\",\"routeName\":\"Memberprice\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:44', 18);
INSERT INTO `sys_oper_log` VALUES (4818, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":195,\"menuName\":\"每日秒杀\",\"parentId\":187,\"orderNum\":8,\"path\":\"seckillsession\",\"component\":\"/mall/sms/coupon/seckillsession/index\",\"routeName\":\"Seckillsession\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:35:53', 17);
INSERT INTO `sys_oper_log` VALUES (4819, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":197,\"menuName\":\"订单查询\",\"parentId\":196,\"orderNum\":1,\"path\":\"order\",\"component\":\"/mall/oms/order/order/index\",\"routeName\":\"OrderQuery\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:36:13', 18);
INSERT INTO `sys_oper_log` VALUES (4820, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":198,\"menuName\":\"退货单处理\",\"parentId\":196,\"orderNum\":2,\"path\":\"return\",\"component\":\"/mall/oms/order/return/index\",\"routeName\":\"OrderReturn\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:36:20', 9);
INSERT INTO `sys_oper_log` VALUES (4821, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":199,\"menuName\":\"等级规则\",\"parentId\":196,\"orderNum\":3,\"path\":\"level\",\"component\":\"/mall/oms/order/level/index\",\"routeName\":\"LevelSettings\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:36:26', 18);
INSERT INTO `sys_oper_log` VALUES (4822, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":200,\"menuName\":\"支付流水查询\",\"parentId\":196,\"orderNum\":4,\"path\":\"payment\",\"component\":\"/mall/oms/order/payment/index\",\"routeName\":\"PaymentLog\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:36:38', 16);
INSERT INTO `sys_oper_log` VALUES (4823, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":201,\"menuName\":\"退款流水查询\",\"parentId\":196,\"orderNum\":5,\"path\":\"refund\",\"component\":\"/mall/oms/order/refund/index\",\"routeName\":\"RefundLog\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:36:44', 17);
INSERT INTO `sys_oper_log` VALUES (4824, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":203,\"menuName\":\"会员列表\",\"parentId\":202,\"orderNum\":1,\"path\":\"member\",\"component\":\"/mall/ums/member/member/inidex\",\"routeName\":\"MemberList\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:09', 18);
INSERT INTO `sys_oper_log` VALUES (4825, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":204,\"menuName\":\"会员等级\",\"parentId\":202,\"orderNum\":2,\"path\":\"level\",\"component\":\"/mall/ums/member/level/index\",\"routeName\":\"MemberLevel\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:15', 12);
INSERT INTO `sys_oper_log` VALUES (4826, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":205,\"menuName\":\"积分变化\",\"parentId\":202,\"orderNum\":3,\"path\":\"growth\",\"component\":\"/mall/ums/member/growth/index\",\"routeName\":\"GrowthRecord\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:21', 10);
INSERT INTO `sys_oper_log` VALUES (4827, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":206,\"menuName\":\"统计信息\",\"parentId\":202,\"orderNum\":4,\"path\":\"statistics\",\"component\":\"/mall/ums/member/statistics/index\",\"routeName\":\"MemberStatistics\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:26', 16);
INSERT INTO `sys_oper_log` VALUES (4828, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":208,\"menuName\":\"首页推荐\",\"parentId\":207,\"orderNum\":1,\"path\":\"home\",\"component\":\"/mall/cms/content/home/index\",\"routeName\":\"HomeRecommend\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\",\"remark\":\" — （路由：content/index）\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:39', 18);
INSERT INTO `sys_oper_log` VALUES (4829, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":209,\"menuName\":\"分类热门\",\"parentId\":207,\"orderNum\":2,\"path\":\"category\",\"component\":\"/mall/cms/content/category/index\",\"routeName\":\"CategoryHot\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:48', 18);
INSERT INTO `sys_oper_log` VALUES (4830, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":210,\"menuName\":\"评论管理\",\"parentId\":207,\"orderNum\":3,\"path\":\"comments\",\"component\":\"/mall/cms/content/comments/index\",\"routeName\":\"CommentManage\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:37:54', 11);
INSERT INTO `sys_oper_log` VALUES (4831, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":203,\"menuName\":\"会员列表\",\"parentId\":202,\"orderNum\":1,\"path\":\"member\",\"component\":\"/mall/ums/member/member/index\",\"routeName\":\"MemberList\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"#\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-23 21:48:59', 16);
INSERT INTO `sys_oper_log` VALUES (4832, '操作日志', 0, 'cn.org.starpivot.system.controller.SysOperLogController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/operlog/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":7,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"businessType\":2,\"costTime\":16,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":\\\"修改菜单成功\\\",\\\"fail\\\":false,\\\"message\\\":\\\"操作成功\\\",\\\"success\\\":true}\",\"method\":\"cn.org.starpivot.system.controller.SysMenuController.edit()\",\"operId\":4831,\"operIp\":\"0:0:0:0:0:0:0:1\",\"operLocation\":\"内网IP\",\"operName\":\"admin\",\"operParam\":\"{\\\"menuId\\\":203,\\\"menuName\\\":\\\"会员列表\\\",\\\"parentId\\\":202,\\\"orderNum\\\":1,\\\"path\\\":\\\"member\\\",\\\"component\\\":\\\"/mall/ums/member/member/index\\\",\\\"routeName\\\":\\\"MemberList\\\",\\\"isFrame\\\":1,\\\"isCache\\\":1,\\\"menuType\\\":\\\"C\\\",\\\"visible\\\":\\\"0\\\",\\\"status\\\":\\\"0\\\",\\\"perms\\\":\\\"\\\",\\\"icon\\\":\\\"#\\\"}\",\"operTime\":\"2026-06-23 21:48:59\",\"operUrl\":\"/api/v1/sys/menu\",\"operatorType\":1,\"requestMethod\":\"PUT\",\"status\":0,\"title\":\"修改菜单\"},{\"businessType\":2,\"costTime\":11,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":\\\"修改菜单成功\\\",\\\"fail\\\":false,\\\"message\\\":\\\"操作成功\\\",\\\"success\\\":true}\",\"method\":\"cn.org.starpivot.system.controller.SysMenuController.edit()\",\"operId\":4830,\"operIp\":\"0:0:0:0:0:0:0:1\",\"operLocation\":\"内网IP\",\"operName\":\"admin\",\"operParam\":\"{\\\"menuId\\\":210,\\\"menuName\\\":\\\"评论管理\\\",\\\"parentId\\\":207,\\\"orderNum\\\":3,\\\"path\\\":\\\"comments\\\",\\\"component\\\":\\\"/mall/cms/content/comments/index\\\",\\\"routeName\\\":\\\"CommentManage\\\",\\\"isFrame\\\":1,\\\"isCache\\\":1,\\\"menuType\\\":\\\"C\\\",\\\"visible\\\":\\\"0\\\",\\\"status\\\":\\\"0\\\",\\\"perms\\\":\\\"\\\",\\\"icon\\\":\\\"#\\\"}\",\"operTime\":\"2026-06-23 21:37:54\",\"operUrl\":\"/api/v1/sys/menu\",\"operatorType\":1,\"requestMethod\":\"PUT\",\"status\":0,\"title\":\"修改菜单\"},{\"businessType\":2,\"costTime\":18,\"deptName\":\"星枢科技\",\"errorMsg\":\"\",\"jsonResult\":\"{\\\"code\\\":200,\\\"data\\\":\\\"修改菜单成功\\\",\\\"fail\\\":false,\\\"message\\\":\\\"操作成功\\\",\\\"success\\\":true}\",\"method\":\"cn.org.starpivot.system.controller.SysMenuController.edit()\",\"operId\":4829,\"operIp\":\"0:0:0:0:0:0:0:1\",\"operLocation\":\"内网IP\",\"...', 0, '', '2026-06-24 12:43:27', 206);
INSERT INTO `sys_oper_log` VALUES (4833, '登录日志', 0, 'cn.org.starpivot.system.controller.SysLogininforController.pageList()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/logininfor/pageList', '0:0:0:0:0:0:0:1', '内网IP', '{\"pageNum\":1,\"pageSize\":20}', '{\"code\":200,\"data\":{\"pageCount\":1,\"pageNum\":1,\"pageSize\":20,\"rows\":[{\"browser\":\"Chrome\",\"infoId\":479,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-24 12:43:02\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":478,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 21:27:16\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Unknown\",\"infoId\":477,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 19:32:08\",\"msg\":\"密码错误\",\"os\":\"Windows 10\",\"status\":\"1\",\"userName\":\"admin\"},{\"browser\":\"Unknown\",\"infoId\":476,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 19:31:13\",\"msg\":\"密码错误\",\"os\":\"Windows 10\",\"status\":\"1\",\"userName\":\"admin\"},{\"browser\":\"Unknown\",\"infoId\":475,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 19:30:19\",\"msg\":\"密码错误\",\"os\":\"Windows 10\",\"status\":\"1\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":474,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 19:27:03\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":473,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 19:26:45\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":472,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 15:53:55\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":471,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 14:48:34\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName\":\"admin\"},{\"browser\":\"Chrome\",\"infoId\":470,\"ipaddr\":\"0:0:0:0:0:0:0:1\",\"loginLocation\":\"内网IP\",\"loginTime\":\"2026-06-23 10:11:29\",\"msg\":\"登录成功\",\"os\":\"Windows 10\",\"status\":\"0\",\"userName...', 0, '', '2026-06-24 12:43:29', 15);
INSERT INTO `sys_oper_log` VALUES (4834, '修改菜单', 2, 'cn.org.starpivot.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', '星枢科技', '/api/v1/sys/menu', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuId\":188,\"menuName\":\"优惠券管理\",\"parentId\":187,\"orderNum\":1,\"path\":\"coupon\",\"component\":\"/mall/sms/coupon/coupon/index\",\"routeName\":\"CouponManager\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"\",\"icon\":\"mdi:candy\"}', '{\"code\":200,\"data\":\"修改菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-24 13:12:06', 47);
INSERT INTO `sys_oper_log` VALUES (4835, '新增菜单', 1, 'cn.org.starpivot.system.controller.SysMenuController.add()', 'POST', 1, 'admin', '星枢科技', '/api/v1/sys/menu/add', '0:0:0:0:0:0:0:1', '内网IP', '{\"menuName\":\"工作单列表\",\"parentId\":183,\"orderNum\":2,\"component\":\"\",\"isFrame\":1,\"isCache\":1,\"menuType\":\"F\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"mall:task:list\"}', '{\"code\":200,\"data\":\"新增菜单成功\",\"fail\":false,\"message\":\"操作成功\",\"success\":true}', 0, '', '2026-06-24 13:16:20', 23);
