...
) ENGINE = InnoDB AUTO_INCREMENT = 333 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (350, '文件重命名', 170, 10, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:edit', '#', 'admin', '2026-06-26 00:00:00', '', NULL, '修改文件展示名称');
...
INSERT INTO `sys_menu` VALUES (188, '优惠券管理', 187, 1, 'coupon', '/mall/sms/coupon/coupon/index', NULL, 'CouponManager', 1, 1, 'C', '0', '0', 'mall:coupon:list', 'mdi:candy', 'admin', '2026-06-23 16:56:59', 'admin', '2026-06-24 15:00:55', '');
...
INSERT INTO `sys_menu` VALUES (199, '等级规则', 196, 3, 'level', '/mall/oms/order/level/index', NULL, 'LevelSettings', 1, 1, 'C', '0', '0', 'mall:order:setting', '#', 'admin', '2026-06-23 17:10:11', 'admin', '2026-06-24 15:36:48', '');
...
INSERT INTO `sys_menu` VALUES (208, '首页推荐', 207, 1, 'home', '/mall/cms/content/home/index', NULL, 'HomeRecommend', 1, 1, 'C', '0', '0', 'mall:adv:list', '#', 'admin', '2026-06-23 17:18:06', 'admin', '2026-06-24 15:36:48', ' — （路由：content/index）');
INSERT INTO `sys_menu` VALUES (209, '分类热门', 207, 2, 'category', '/mall/cms/content/category/index', NULL, 'CategoryHot', 1, 1, 'C', '0', '0', '', '#', 'admin', '2026-06-23 17:18:49', 'admin', '2026-06-24 15:36:48', '无独立表，引导至专题活动 sms_home_subject');
INSERT INTO `sys_menu` VALUES (210, '评论管理', 207, 3, 'comments', '/mall/cms/content/comments/index', NULL, 'CommentManage', 1, 1, 'C', '0', '0', 'mall:comment:list', '#', 'admin', '2026-06-23 17:19:35', 'admin', '2026-06-24 15:36:48', '');
...
INSERT INTO `sys_menu` VALUES (305, '积分新增', 192, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:bounds:add', '#', 'admin', '2026-06-24 15:36:48', '', NULL, '');
INSERT INTO `sys_menu` VALUES (306, '积分修改', 192, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:bounds:edit', '#', 'admin', '2026-06-24 15:36:48', '', NULL, '');
INSERT INTO `sys_menu` VALUES (307, '积分删除', 192, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:bounds:delete', '#', 'admin', '2026-06-24 15:36:48', '', NULL, '');
INSERT INTO `sys_menu` VALUES (308, '会员价查询', 194, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:memberprice:query', '#', 'admin', '2026-06-24 15:36:48', '', NULL, '');
INSERT INTO `sys_menu` VALUES (309, '会员价新增', 194, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:memberprice:add', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (310, '会员价修改', 194, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:memberprice:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (311, '会员价删除', 194, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:memberprice:delete', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (312, '满减查询', 193, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:reduction:query', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (313, '满减新增', 193, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:reduction:add', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (314, '满减修改', 193, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:reduction:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (315, '满减删除', 193, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:reduction:delete', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (316, '秒杀查询', 191, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:query', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (317, '秒杀新增', 191, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:add', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (318, '秒杀修改', 191, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (319, '秒杀删除', 191, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:delete', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (320, '场次新增', 195, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:session:add', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (321, '场次修改', 195, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:session:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (322, '场次删除', 195, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:seckill:session:delete', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (323, '专题查询', 190, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:subject:query', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (324, '专题新增', 190, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:subject:add', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (325, '专题修改', 190, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:subject:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (326, '专题删除', 190, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:subject:delete', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (327, '支付流水查询', 200, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:payment:query', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (328, '退款流水查询', 201, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:refund:query', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (329, '等级新增', 204, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:member:level:add', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (330, '等级修改', 204, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:member:level:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (331, '等级删除', 204, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:member:level:delete', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (332, '采购单处理', 186, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:purchase:edit', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (333, '优惠券查询', 188, 4, '', '', NULL, '', 1, 0, 'F', '0', '0', 'mall:coupon:query', '#', 'admin', '2026-06-24 15:36:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (334, '审批中心', 0, 5, '/approval', '', NULL, 'ApprovalCenter', 1, 1, 'M', '0', '0', '', 'mdi:clipboard-check-outline', 'admin', '2026-06-26 10:49:49', '', NULL, 'SAS 审批中台');
INSERT INTO `sys_menu` VALUES (335, '审批模板', 334, 1, 'template', '/approval/template/index', NULL, 'ApprovalTemplate', 1, 1, 'C', '0', '0', 'approval:template:query', 'ep:document', 'admin', '2026-06-26 10:49:49', '', NULL, '审批模板配置');
INSERT INTO `sys_menu` VALUES (336, '业务绑定', 334, 2, 'bind', '/approval/bind/index', NULL, 'ApprovalBind', 1, 1, 'C', '0', '0', 'approval:bind:edit', 'ep:link', 'admin', '2026-06-26 10:49:49', '', NULL, '业务类型绑定规则');
INSERT INTO `sys_menu` VALUES (337, '待办审批', 334, 3, 'todo', '/approval/todo/index', NULL, 'ApprovalTodo', 1, 1, 'C', '0', '0', 'approval:task:query', 'ri:bell-line', 'admin', '2026-06-26 10:49:49', '', NULL, '待办与已办');
INSERT INTO `sys_menu` VALUES (338, '我发起的', 334, 4, 'mine', '/approval/mine/index', NULL, 'ApprovalMine', 1, 1, 'C', '0', '0', 'approval:instance:query', 'mdi:user-arrow-right', 'admin', '2026-06-26 10:49:49', '', NULL, '我发起的审批');
INSERT INTO `sys_menu` VALUES (339, '模板编辑', 335, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:template:edit', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (340, '模板发布', 335, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:template:publish', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (341, '绑定编辑', 336, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:bind:edit', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (342, '待办查询', 337, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:task:query', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (343, '审批操作', 337, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:task:action', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (344, '提交审批', 337, 3, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:instance:submit', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (345, '发起查询', 338, 1, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:instance:query', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
INSERT INTO `sys_menu` VALUES (346, '撤回审批', 338, 2, '', '', NULL, '', 1, 0, 'F', '0', '0', 'approval:instance:withdraw', '#', 'admin', '2026-06-26 10:49:49', '', NULL, '');
