...
import cn.org.starpivot.monitor.filter.MonitorAuthenticationFilter;
...
public class MonitorSecurityConfig {
    ...
    private final MonitorAuthenticationFilter monitorAuthenticationFilter;
    ...
    public SecurityFilterChain monitorSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .addFilterBefore(monitorAuthenticationFilter, UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
}
