...
import cn.org.starpivot.approval.config.ApprovalSecurityProperties;
...
public class ApprovalPermissionLoader {

    private final JdbcTemplate jdbcTemplate;
    private final ApprovalSecurityProperties approvalSecurityProperties;

    public List<String> selectPermissionsByUserId(Long userId) {
        String schema = approvalSecurityProperties.validatedSystemDbSchema();
