...
import cn.org.starpivot.mall.common.OrderPortalFeignSupport;
...
public class PortalSeckillServiceImpl implements PortalSeckillService {
    ...
    private final OrderPortalFeignSupport orderPortalFeignSupport;
    ...
    public PortalOrderSubmitVo placeOrder(Long memberId, PortalSeckillOrderBo bo) {
        ...
        try {
            ...
            PortalOrderSubmitVo result = orderPortalFeignSupport.submitOrder(memberId, submitBo);
