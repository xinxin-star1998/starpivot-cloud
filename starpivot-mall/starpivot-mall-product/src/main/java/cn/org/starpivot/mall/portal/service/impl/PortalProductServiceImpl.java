...
import cn.org.starpivot.mall.common.MallStockFeignSupport;
...
public class PortalProductServiceImpl implements PortalProductService {
    ...
    private PageResponse<PortalProductListVo> searchFromDatabase(PortalProductSearchBo bo) {
        ...
        reqBo.setPublishStatus(MallProductConstants.PUBLISH_STATUS_ON);
    ...
    private void fillSkuAvailableStock(List<Skus> skus) {
        ...
        Map<Long, Integer> stockMap = mallStockFeignSupport.requireAvailableStockMap(skuIds);
        for (Skus sku : skus) {
