...
public interface AlipayPayService {
     ...
     * @return 支付宝退款结果摘要
     */
    AlipayRefundResult refund(String orderSn, String alipayTradeNo, BigDecimal refundAmount, String outRequestNo);

    /**
     * 查询退款结果（对账/状态同步）。
     */
    AlipayRefundResult queryRefund(String orderSn, String alipayTradeNo, String outRequestNo);
